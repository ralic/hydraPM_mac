...
/* C compiler */
#define HYDRA_CC "mpicc -I/usr/local/opt/python3/include -I/usr/local/opt/lapack/include -I/usr/local/opt/openblas/include -I/usr/local/opt/llvm/include -I/usr/local/opt/sqlite/include -I/usr/local/opt/readline/include -I/usr/local/opt/openssl@1.1/include -I/usr/X11/include  -D_DARWIN_C_SOURCE -fomit-frame-pointer -funroll-loops  -ffast-math -Ofast -fno-signed-zeros -ffp-contract=fast -mmmx -msse -maes -march=native  -g -march=native  -I/usr/local/opt/python3/lib -L/usr/local/opt/lapack/lib -L/usr/local/opt/openblas/lib -L/usr/local/opt/llvm/lib -L/usr/local/opt/sqlite/lib -L/usr/local/opt/readline/lib -L/usr/local/opt/openssl@1.1/lib -L/usr/X11/lib  "

/* Configure arguments */
#define HYDRA_CONFIGURE_ARGS_CLEAN "'prefix=/usr/local/Cellar/hydraPM/3.2' 'CC=mpicc' 'CFLAGS=-fomit-frame-pointer -funroll-loops -ffast-math -Ofast -fno-signed-zeros -ffp-contract=fast -mmmx -msse -maes -march=native -g -march=native' 'LDFLAGS=-I/usr/local/opt/python3/lib -L/usr/local/opt/lapack/lib -L/usr/local/opt/openblas/lib -L/usr/local/opt/llvm/lib -L/usr/local/opt/sqlite/lib -L/usr/local/opt/readline/lib -L/usr/local/opt/openssl@1.1/lib -L/usr/X11/lib ' 'CPPFLAGS=-I/usr/local/opt/python3/include -I/usr/local/opt/lapack/include -I/usr/local/opt/openblas/include -I/usr/local/opt/llvm/include -I/usr/local/opt/sqlite/include -I/usr/local/opt/readline/include -I/usr/local/opt/openssl@1.1/include -I/usr/X11/include ' 'CPP='"

/* C++ compiler */
#define HYDRA_CXX "g++-7 -I/usr/local/opt/python3/include -I/usr/local/opt/lapack/include -I/usr/local/opt/openblas/include -I/usr/local/opt/llvm/include -I/usr/local/opt/sqlite/include -I/usr/local/opt/readline/include -I/usr/local/opt/openssl@1.1/include -I/usr/X11/include  -D_DARWIN_C_SOURCE  -I/usr/local/opt/python3/lib -L/usr/local/opt/lapack/lib -L/usr/local/opt/openblas/lib -L/usr/local/opt/llvm/lib -L/usr/local/opt/sqlite/lib -L/usr/local/opt/readline/lib -L/usr/local/opt/openssl@1.1/lib -L/usr/X11/lib  "
...
#define HYDRA_RELEASE_DATE "Wed Nov 11 22:06:48 CST 2015"

/* Hydra version information */
#define HYDRA_VERSION "3.2"
...
#define PACKAGE_STRING "Hydra 3.2"
